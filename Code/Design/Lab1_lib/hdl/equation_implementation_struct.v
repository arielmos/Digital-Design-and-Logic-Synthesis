//
// Module Lab1_lib.Equation_Implementation.struct
//
// Created:
//          by - amitnag.UNKNOWN (SHOHAM)
//          at - 18:25:27 11/29/2020
//
...
reg   [31:0] sum3;         // each sumX is the double Sigma from each (X) equation // 510*72*72*data_depth
reg   [31:0] sum4;         // each sumX is the double Sigma from each (X) equation // 510*72*72*data_depth
reg   [31:0] sum5;         // each sumX is the double Sigma from each (X) equation // 510*72*72*data_depth
...
wire  [9:0]  pow;          // return answer for 2^(-((Mu-0.5)^2)), in milli!!
//--------------------------result always-------------
...
// HDL Embedded Text Block 1 sums_calc
...
// HDL Embedded Text Block 2 eq345_calc
...
// HDL Embedded Text Block 3 eq12_calc
...
// HDL Embedded Text Block 4 watermarking_result
...
// HDL Embedded Text Block 5 block_done_always
always @(posedge  ena_in) begin: block_done_always
   block_done <=0;
end

endmodule // Equation_Implementation
/*      
  parametrs map:
